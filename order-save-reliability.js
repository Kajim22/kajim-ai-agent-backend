// Make order extraction independent of fragile JSON-mode/model combinations and
// make the order insert report success before the in-memory orderSaved flag is set.
const fs = require('fs');
