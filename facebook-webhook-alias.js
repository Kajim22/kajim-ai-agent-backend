...
// Also validates Facebook Page Access Tokens before /facebook/connect saves them.
...
express.application.post = function (path, ...handlers) {
  if (path === '/facebook/connect') {
    const validateFacebookToken = async (req, res, next) => {
      try {
    ...
    return originalPost.call(this, path, validateFacebookToken, ...handlers);
  }
